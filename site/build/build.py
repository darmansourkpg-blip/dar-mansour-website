...
<section class="section pd" id="private">
  <div class="pd__bg"><img src="assets/uploads/Dar%20Mansour%20-%20Morocco%27s%20kitchen%20Service.jpg" alt="Guests celebrating together around the mosaic table at a Dar Mansour Moroccan dinner" style="object-position:center 38%"></div>
...
founders_body = L.breadcrumb(("Founders", None)) + L.subhero(
    ...
    "assets/uploads/mod_aimant1.jpg", "Maïja and Bruno, founders of Dar Mansour, sharing a tender embrace", tall=True, focus="center 62%") + f'''
<section class="section"><div class="wrap prose reveal">
